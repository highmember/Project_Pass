...
@Component({
  selector: 'app-reportdi',
  templateUrl: './reportdi.component.html'
})

/**
 * manage about degree dialog insert, edit, delete data
 */
export class reportdiComponent implements OnInit {
  /**
  ...
  */
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<reportdiComponent>,
  ) { }
  /**
